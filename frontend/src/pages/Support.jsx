...
const Support = () => {
  ...
  useEffect(() => {
    const url = `http://localhost:5000/api/v1/helplines${showOpenNow ? '?openNow=true' : ''}`;
  ...
  if (loading) return <div className="loading">Loading...</div>; // show loading while data gets fetched 
