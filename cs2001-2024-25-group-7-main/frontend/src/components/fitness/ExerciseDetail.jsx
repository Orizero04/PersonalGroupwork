        ...
        <div className="container mx-auto p-4 mt-10" >
            ...
            <div className="flex flex-col md:flex-row gap-8">
                <div className="md:w-1/2 lg:w-2/5">
                    {/* Image container */}
                    <div className="relative h-96 overflow-hidden rounded shadow">
                        <img
                            src={mainImage}
                            alt={name}
                    ...
                    {/* Alternative Exercises below the image */}
                    <div className="mt-4">
                        <AlternativeExercises primaryMuscle={primaryMuscles[0]._id} muscleName={primaryMuscles[0].name} currentExerciseId={exercise._id} />
                    </div>
                </div>
